...
export default function Signup() {
  ...
  // Make sure .env.local has REACT_APP_API_URL=http://localhost:5000
  ...
  // Google signup/login (via Firebase)
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      setMessage(err.response?.data?.error || err.message || "Google signup failed");
    }
  };
